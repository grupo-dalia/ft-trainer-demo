const CACHE_VERSION = "ft-trainer-pwa-v10";
const CORE_ASSETS = ["/", "/index.html", "/cliente.html", "/pendiente.html", "/manifest.webmanifest", "/assets/pwa/ft-icon-192.png", "/assets/pwa/ft-icon-512.png", "/assets/brand/ft-symbol-color.png", "/assets/brand/ft-horizontal-color.png", "/portal.css?v=10", "/client-home.css?v=7", "/client-training-v2.css?v=5", "/client-materials.css?v=1", "/client-hall-of-fame.css?v=1", "/pwa-safe-area.css?v=1", "/pwa.css?v=1", "/pwa.js?v=3", "/cliente.js?v=28", "/cliente-base.js?v=2", "/client-home.js?v=7", "/client-sections.js?v=16", "/client-materials.js?v=1", "/client-hall-of-fame.js?v=1", "/client-navigation-fix.js?v=1", "/vendor/supabase-js.min.js", "/supabase-config.js?v=2"];
